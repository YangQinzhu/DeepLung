...
changable variable
"""
MAP_FRAME = '/data/yangqinzhu/ctLung/DeepLung-master/nodcls/data/LIDC-IDRI-mappingLUNA16'
LIDC_CSV_FRAME = '/data/yangqinzhu/ctLung/DeepLung-master/nodcls/data/list3.2.xls'
...
# read LIDC dataset
lunantdictlidc = np.load(lunaantdictlidc_npy).item()
import xlrd
lidccsvfname = LIDC_CSV_FRAME
antdict = {}
...
# fd 1
fd1lst = []
for fname in os.listdir(LUNA_SUB_FOLD+str(fold)+'/'):
...
fid.close()
subset1path = LUNA_SUB_FOLD+str(fold)+'/'
testfnamelst = []
